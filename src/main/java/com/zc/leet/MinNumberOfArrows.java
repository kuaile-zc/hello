...
public class MinNumberOfArrows {
    ...
    public int findMinArrowShots2(int[][] points) {
        ...
        for (int i=1; i<length; i++){
            if (rightIndex<points[i][0]){
                ans++;
                rightIndex = points[i][1];
            }else if (points[i][1]<rightIndex){
                rightIndex = points[i][1];
            }
        }
    ...
    public static void main(String[] args) {
        ...
        minNumberOfArrows.findMinArrowShots2(new int[][]{{3,9},{7,12},{3,8},{6,8},{9,10},{2,9},{0,9},{3,9},{0,6},{2,8}});
    }
}
